...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        insertLocationRow(db);

        db.close();
    }

    private long insertLocationRow(SQLiteDatabase db) {
        ...
        assertTrue(rowId != -1);
//       Log.d(LOG_TAG,cursor.getString(cursor.getColumnIndex(WeatherContract.LocationEntry.COLUMN_CITY_NAME)));
    ...
    public void testWeatherTable() {
        ...
        long locationRowId = insertLocationRow(db);
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: Empty database", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: weather content validation failed", cursor, contentValues);
        // Finally, close the cursor and database
        cursor.close();
        db.close();
    }
